...
function HotShelf({ books: hotBooks }: { books: SourceBook[] }) {
  return (
    <section id="truyen-hot" className="border-b border-zinc-200 bg-white/90 backdrop-blur">
...
function LatestList({ latestBooks }: { latestBooks: SourceBook[] }) {
  ...
  return (
    <section id="truyen-moi-cap-nhat" className="overflow-hidden rounded-md border border-zinc-200 bg-white/95 shadow-sm backdrop-blur">
...
function Sidebar({ categories, recommendedBooks }: { categories: SourceCategory[]; recommendedBooks: SourceBook[] }) {
  return (
    <aside className="space-y-4">
      <section id="the-loai-truyen" className="rounded-md border border-zinc-200 bg-white/95 shadow-sm backdrop-blur">
      ...
      <section id="top-de-cu" className="rounded-md border border-zinc-200 bg-white/95 shadow-sm backdrop-blur">
...
function CompletedShelf({ completedBooks }: { completedBooks: SourceBook[] }) {
  ...
  return (
    <section id="truyen-hoan-thanh" className="mt-5 rounded-md border border-zinc-200 bg-white/95 shadow-sm backdrop-blur">
...
export default async function HomePage() {
  ...
  return (
    <main
      ...
      style={{
        backgroundImage:
          "linear-gradient(180deg, rgba(250,250,249,0.88), rgba(250,250,249,0.72) 38%, rgba(244,244,245,0.9)), url('/images/home-background.png')"
      }}
    >
      ...
      <div className="border-b border-red-950 bg-red-900/90 text-white backdrop-blur">
